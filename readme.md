...
---
# TODO: Corregir y modificar para awesome-uc-web
El repositorio de awesome-uc va a ser de donde se recojan los proyectos y se agregen como `submodles` a este repositorio. La idea es que se encuentre `repo/projects\category/project-name/@project-submodule`, adicionalmente bajo `repo/projects/category/project-name/` se va a colocar una plantilla de .md más recursos gráficos en `repo/projects/category/project-name/media`. Esta plantilla de `markdown` será usada para mostrar catalogar y mostrar el resumen del proyecto que se mostrará en la página.
